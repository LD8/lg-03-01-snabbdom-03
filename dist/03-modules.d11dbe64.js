...
// 导入模块
// 注册模块
var patch = (0, _init.init)([_style.styleModule, _eventlisteners.eventListenersModule]); // 传入模块需要的数据（对象）
...
}, [(0, _h.h)('h1#h1', 'h1 Node'), (0, _h.h)('p#p', 'p Node', [(0, _h.h)('span', 'span1 '), (0, _h.h)('span', 'span2')])]); // console.log(vnode)
