...
var vnode = (0, _h.h)('p#container.cls', 'Hello World!');
var app = document.querySelector('#app'); // 似乎是将 app 替换成了 vnode

var oldVNode = patch(app, vnode);
console.log(oldVNode === vnode); // true

var newVNode = (0, _h.h)('h1', 'Snabbdom Rules!!');
console.log(newVNode); // 老左新右
